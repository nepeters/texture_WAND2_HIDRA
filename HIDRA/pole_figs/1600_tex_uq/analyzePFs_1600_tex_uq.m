...
% created from reduce_fit python script @ 2022-07-20 14:14:13.175542
...
rot1 = rotation('axis',zvector,'angle',97*degree);
...
% path to files
fname_FCC = {...
  '1600_tex_uq_FCC_222.pf',...
  '1600_tex_uq_FCC_311.pf',...
  '1600_tex_uq_FCC_220.pf',...
  };

fname_BCC = {...
  '1600_tex_uq_BCC_220.pf',...
  '1600_tex_uq_BCC_200.pf',...
  };
...
% [~,cen_rot,~,~] = centerSpecimen(rodf_FCC,yvector,'Fourier','silent');
...
[~,cen_rot,~,~] = centerSpecimen(rodf_BCC,yvector,'Fourier','silent');
rcodf_BCC = rotate(rodf_BCC,cen_rot);
repf_BCC = calcPoleFigure(rcodf_BCC, h_BCC);
