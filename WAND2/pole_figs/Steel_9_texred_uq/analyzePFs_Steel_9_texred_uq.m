...
% path to files
fname_FCC = {...
  'Steel_9_texred_uq_FCC_400.pf',...
  'Steel_9_texred_uq_FCC_222.pf',...
  'Steel_9_texred_uq_FCC_311.pf',...
  'Steel_9_texred_uq_FCC_220.pf',...
  'Steel_9_texred_uq_FCC_200.pf',...
  'Steel_9_texred_uq_FCC_111.pf',...
  };

fname_BCC = {...
  'Steel_9_texred_uq_BCC_310.pf',...
  'Steel_9_texred_uq_BCC_220.pf',...
  'Steel_9_texred_uq_BCC_211.pf',...
  'Steel_9_texred_uq_BCC_200.pf',...
  'Steel_9_texred_uq_BCC_110.pf',...
  };
...
%         npf_BCC(npf_BCC.isOutlier) = [];
    ...
    fname = sprintf('bootstrap_res_n%i.csv',n_boot);
...
save('odf_BCC_Steel_9_texred_uq','rodf_BCC');
...
save('odf_FCC_Steel_9_texred_uq','rodf_FCC');
