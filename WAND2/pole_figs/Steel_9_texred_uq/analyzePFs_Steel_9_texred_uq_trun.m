...
% created from reduce_fit python script @ 2022-07-13 21:29:20.895330
...
rot1 = rotation('axis',zvector,'angle',105*degree);
...
% path to files
fname_FCC = {...
  'Steel_9_texred_uq_FCC_222.pf',...
  'Steel_9_texred_uq_FCC_311.pf',...
  'Steel_9_texred_uq_FCC_220.pf',...
  };

fname_BCC = {...
  'Steel_9_texred_uq_BCC_220.pf',...
  'Steel_9_texred_uq_BCC_200.pf',...
  };
...
pf_BCC = PoleFigure(allH2, allR2, allI2);
...
for bi=1:length(n_boots)
    ...
    n_h1       = length(fname_FCC);
    n_h2       = length(fname_BCC);
    I1 = cell(n_boot,1);
    I2 = cell(n_boot,1);
    ...
    parfor n=1:n_boot
        ...
        npf_FCC  = PoleFigure(allH1, allR1, I1{n});
%         npf_FCC(npf_FCC.isOutlier) = [];
        ...
        [~,ncen_rot_FCC{n},~,~] = centerSpecimen(nodf_FCC,xvector,'Fourier','silent');
        nodf_FCC = rotate(nodf_FCC, ncen_rot_FCC{n});
...
%         npf_BCC(npf_BCC.isOutlier) = [];
    ...
    for i=1:length(ncen_rot_FCC)
        cen_rots(i,:) = ncen_rot_FCC{i}.Euler;
    end
...
save('odf_BCC_Steel_9_texred_uq_trun','rodf_BCC');
...
saveFigure('BCC_phi2_45_trun.jpg')
close

% _2 is phase: FCC

rodf_FCC = rotate(rodf_FCC,cen_rot);
save('odf_FCC_Steel_9_texred_uq_trun','rodf_FCC');
...
saveFigure('FCC_phi2_45_trun.jpg')
close
...
mtexColorbar('title','BCC')
saveFigure('BCC_pfs_trun.jpg')
close

figure
plot(rpf_BCC{nh_BCC-1:nh_BCC})
mtexColorbar
saveFigure('BCC_rawpfs_trun.jpg')
close
...
mtexColorbar('title','FCC')
saveFigure('FCC_pfs_trun.jpg')
close

figure
plot(rpf_FCC{nh_FCC-1:nh_FCC})
mtexColorbar
saveFigure('FCC_rawpfs_trun.jpg')
close
...
% mtexColorbar
% saveFigure('BCC_betabrassE_trun.jpg')
% close
% 
% figure
% plotPDF(fodf_1,h_BCC{end},'contourf','colorrange',[0 2])
% mtexColorbar
% saveFigure('BCC_fodf4_pfs_trun.jpg')
% close
% 
...
% mtexColorbar
% saveFigure('FCC_betabrassE_trun.jpg')
% close
% 
% figure
% plotPDF(fodf_2,h_FCC{end},'contourf','colorrange',[0 2])
% mtexColorbar
% saveFigure('FCC_fodf4_pfs_trun.jpg')
% close
