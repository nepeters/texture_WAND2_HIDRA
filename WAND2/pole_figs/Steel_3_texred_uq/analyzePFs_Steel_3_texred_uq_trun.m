...
% created from reduce_fit python script @ 2022-07-13 11:50:56.956167
...
rot1 = rotation('axis',zvector,'angle',25*degree);
...
% path to files
fname_BCC = {...
  'Steel_3_texred_uq_BCC_220.pf',...
  'Steel_3_texred_uq_BCC_200.pf',...
  };

fname_FCC = {...
  'Steel_3_texred_uq_FCC_222.pf',...
  'Steel_3_texred_uq_FCC_311.pf',...
  'Steel_3_texred_uq_FCC_220.pf',...
  };
...
save('odf_BCC_Steel_3_texred_uq_trun','rodf_BCC');
...
save('odf_FCC_Steel_3_texred_uq_trun','rodf_FCC');
